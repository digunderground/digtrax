...
// digtrax local patch: upstream points at "system/sysutils.h" which
// doesn't exist in the current source tree. The header is at
// "common/sysutils.h"; we already have -Isrc on the include path.
