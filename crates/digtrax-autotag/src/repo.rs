...
// Custom platform plugin manifest + downloads.
// TODO: stand up a DigTrax-platforms repo and point these at it. Until then the manifest
// fetch will return an error and the UI will show no installable platforms — graceful
// degradation; the built-in platforms (Beatport, Discogs, Spotify, etc.) keep working.
const MANIFEST_URL: &str = "https://raw.githubusercontent.com/digtrax/digtrax-platforms/master/platforms.json";
const DOWNLOAD_URL: &str = "https://github.com/digtrax/digtrax-platforms/releases/download/platforms";
