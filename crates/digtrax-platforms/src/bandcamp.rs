...
use digtrax_tagger::{supported_tags, AudioFileInfo, AutotaggerSource, AutotaggerSourceBuilder, MatchingUtils, PlatformCustomOptionValue, PlatformCustomOptions, PlatformInfo, TaggerConfig, Track, TrackMatch};
    ...
    fn into(self) -> Track {
        ...
        Track {
            ...
            styles: self.keywords.unwrap_or(vec![]).into_iter()
                ...
                .map(|s| digtrax_shared::capitalize(&s.replace(" and ", " & ")))
                .collect::<Vec<_>>(),
...
impl BandcampPublisherSmall {
    ...
    pub fn genre(&self) -> Option<String> {
        ...
        Some(digtrax_shared::capitalize(&genre))
    }
}
